...
// ---------------------------------------------------------------------
// Top navigation bar for the YouTube Clone application.
// Includes:
// - Logo and Sidebar toggle
// - Search input (visible only on Home Page)
// - Auth buttons (Login, Logout)
// - Channel management: "My Channel" or "Create Channel"
// ---------------------------------------------------------------------
      ...
      <div className="flex items-center gap-2 sm:gap-3 min-w-fit">
        {!user ? (
          ...
          <>
            ...
            {/* Show "My Channel" or "Create Channel" */}
            {hasChannel ? (
              <button
