// frontend/src/components/EditChannelModal.jsx
// ----------------------------------------------------------
// Modal for editing a YouTube-style channel
// Features:
// - Allows updating channel name, description, and banner image
// - Preview of uploaded banner image
// - Validates required input
// Redux slice used: channelSlice
// Props:
...
const EditChannelModal = ({ channel, onClose }) => {
  ...
  // ----------------------------------------------------------
  // Handle error updates from Redux state
  // ----------------------------------------------------------
  useEffect(() => {
    if (error) {
      setLocalError(error);
