// frontend/src/components/VideoCardWithActions.jsx
// ------------------------------------------------------------
// Displays a video card with Edit and Delete options
// - Used inside Channel Page for managing uploaded videos
...
const VideoCardWithActions = ({ video }) => {
  ...
  const handleDelete = async () => {
    if (window.confirm("Are you sure you want to delete this video?")) {
      try {
        await dispatch(deleteVideo(video._id)).unwrap(); // delete from DB
        dispatch(getChannel(video.channel)); // refresh channel data
