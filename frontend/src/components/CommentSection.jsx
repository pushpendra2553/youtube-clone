...
// ----------------------------------------------------------
// Displays comment section below the video
// Features:
// - Fetches and displays comments for a video
// - Allows logged-in users to add, edit, or delete comments
// - Inline editing with permission checks
// Redux slices used: authSlice, commentSlice
// ----------------------------------------------------------
...
const CommentSection = ({ videoId }) => {
  ...
  // ----------------------------------------------------------
  // Global state: user (from authSlice), comments (from commentSlice)
  // ----------------------------------------------------------
  const { user } = useSelector((state) => state.auth);
  const { items: comments, loading } = useSelector((state) => state.comments);

  // ----------------------------------------------------------
  // Local state: for new comment and editing an existing one
  // ----------------------------------------------------------
  ...
  // ----------------------------------------------------------
  // useEffect: fetch comments when videoId changes
  // ----------------------------------------------------------
  useEffect(() => {
    if (videoId) {
