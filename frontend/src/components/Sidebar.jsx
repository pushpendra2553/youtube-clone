...
// --------------------------------------------------------
// Responsive and toggleable sidebar for navigation.
// Includes links for Home, Library (You), and Explore.
// --------------------------------------------------------
...
export default function Sidebar() {
  const { isSidebarOpen } = useSelector((state) => state.ui); // Get toggle state from Redux
