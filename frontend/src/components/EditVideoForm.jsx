// frontend/src/components/EditVideoForm.jsx
// ----------------------------------------------------------
// Form to update an existing video
// Allows updating title, description, category, thumbnail, and video file
// Integrates with formData for backend PATCH upload
// ----------------------------------------------------------
...
const EditVideoForm = ({ video, onSubmit, videoUpdating }) => {
  ...
  // Populate existing video data on mount
  useEffect(() => {
    if (video) {
  ...
  const handleSubmit = (e) => {
    ...
    onSubmit(formData); // Call parent submit function
  };
  ...
  return (
    <form
      ...
      className="space-y-5 max-w-md mx-auto p-4 border rounded-lg shadow"
